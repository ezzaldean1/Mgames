...
client.on('ready', () => {
  ...
  client.user.setStatus("Online")
    client.user.setActivity(" Nabarat Server",{type: 'PLAYING'})
});
...
message.channel.sendEmbed(cat);
 ...
 const cuttweet = [
	 ...
	 '‏كت تويت |  جمال الشخص يكمل ب ؟',

'‏كت تويت | .شخص تحبه ولا شخص يحبك؟ ؟',

'‏كت تويت |  الجمال جمال ال ؟',

'‏كت تويت | منشن شخص وقله ايش تتمنى يكون لو كانت بينكم صلة قرابه ؟ ؟',

'‏كت تويت |  منشن شخصّ واوصفه بكِلمه ..؟',

'‏كت تويت | من الأشياء الي تخليك تصدع  ؟',

'‏كت تويت | أصدقاء الديسكورد ، أصدقاء الحياة الواقعية . ؟',

'‏كت تويت | كلمه توصف وضعك الحالي ؟',

'‏كت تويت | أفضل طريقة لتوصيل المشاعر  ؟',

'‏كت تويت | أكثر كلمه ترفع ضغطك؟',

'‏كت تويت | مقطع من آغنيه تحبهآا؟',
]
